...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        ...
        if ($exception instanceof MethodNotAllowedHttpException) {
            return $this->errorResponse('The specified method is invalid for the request.', 405);
        }
        ...
        if ($exception instanceof QueryException) {
            ...
            if ($errCode == 1451) {
                return $this->errorResponse('Can not delete this resource permanently. It\'s related with other resource.', 409);
            }
        }
